...
curl --location https://git.generalassemb.ly/raw/ga-dc/installfest/master/Rakefile > Rakefile
# Download the config for THIS class
curl --location https://git.generalassemb.ly/raw/ga-dc/installfest/master/installfest_dc_wdi.yml > installfest.yml
